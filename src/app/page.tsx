      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <span className="text-blue-600 font-bold text-2xl">VibeChat</span>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <h3 className="text-xl font-semibold mb-2">User Invitations</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <h3 className="text-xl font-semibold mb-2">Message Quotes</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Share Your ID</h3>
              <p className="text-gray-600">
      ...
      <footer className="bg-gray-800 text-white py-8 mt-auto">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} VibeChat. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
